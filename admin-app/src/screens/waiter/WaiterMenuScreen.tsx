...
import { View, Text, TextInput, TouchableOpacity, FlatList, Image, SafeAreaView, Platform, ActivityIndicator } from 'react-native';
    ...
    useCallback(() => {
      ...
      const loadData = async () => {
        ...
        try {
          ...
          if (isActive) {
            setMenuItems(itemsData.success ? itemsData.data : []);
            setCategories(catsData.success ? catsData.data : []);
          }
        } catch (error) {
    ...
    <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      {isLoading ? (
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32, marginTop: -60 }}>
          ...
          <Text style={{ fontSize: 14, color: '#6B7280' }}>You haven't added any dishes yet.</Text>
        </View>
