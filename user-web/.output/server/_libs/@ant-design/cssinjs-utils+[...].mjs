import { n as __esmMin, r as __toESM, t as __commonJSMin } from "../../_runtime.mjs";
import { a as token2CSSVar, d as removeCSS, f as updateCSS, g as require_react, h as canUseDom, m as useMemo$1, n as useCSSVarRegister, o as unit$1, r as useStyleRegister } from "./cssinjs+[...].mjs";
...
//#endregion
//#region node_modules/@rc-component/util/es/hooks/useDelayState.js
/**
...
function useDelayState(defaultValue) {
	...
	return [value, useEvent((nextValue, immediatelyOrDelay) => {
		const delayConfig = immediatelyOrDelay || { frame: 1 };
		cancelPending();
		if (delayConfig === true) setValue(nextValue);
		else if ("ms" in delayConfig) delayRef.current = [false, setTimeout(() => setValue(nextValue), delayConfig.ms)];
		else delayRef.current = [true, wrapperRaf(() => setValue(nextValue), delayConfig.frame)];
	})];
}
//#endregion
...
var useComposeRef = (...refs) => {
	return useMemo$1(() => composeRef(...refs), refs, (prev, next) => prev.length !== next.length || prev.every((ref, i) => ref !== next[i]));
};
...
var require_react_dom_client_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function estimateBandwidth() {
		if ("function" === typeof performance_default.getEntriesByType) {
			for (var count = 0, bits = 0, resourceEntries = performance_default.getEntriesByType("resource"), i = 0; i < resourceEntries.length; i++) {
...
//#endregion
export { wrapperRaf as A, getNodeRef as C, useSyncState as D, useComposeRef as E, require_react_dom as F, useSafeState as M, useLayoutEffect as N, useId_default as O, useEvent as P, composeRef as S, supportRef as T, triggerFocus as _, _toConsumableArray as a, getDOM as b, merge$1 as c, mergeProps as d, toArray as f, getShadowRoot as g, getTargetScrollBarSize as h, _classCallCheck as i, useControlledState as j, useDelayState as k, set as l, omit as m, merge as n, render as o, pickAttrs as p, _createClass as r, unmount as s, genStyleUtils as t, get as u, useLockFocus as v, supportNodeRef as w, isDOM as x, isVisible_default as y };
